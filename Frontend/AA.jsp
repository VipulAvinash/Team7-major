<%-- 
    Document   : AA
    Created on : Dec 18, 2022, 9:25:07 PM
    Author     : Murthi
--%>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <center><div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                <p class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">Attribute Authority</p>
                                <form method="post" action="AALog">
                                    <div class="row g-3">
                                        <div class="col-12">
