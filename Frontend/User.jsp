                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <center><div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                <p class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">User</p>
                                <form method="post" action="UsersLog">
                                    <div class="row g-3">
                                        <div class="col-12">
                                    ...
                                    <br><br>
                                    New User?? <a href="userreg.jsp">Register</a>
                                </form>
                            </div></center> 
                        <br><br><br><br><br><br><br>
