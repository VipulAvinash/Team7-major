<%-- 
    Document   : Upload
    Created on : Dec 15, 2022, 10:10:40 PM
    Author     : Murthi
--%>
...
<html lang="en">
    ...
    <%
        ...
        <script>alert('File Uploaded To The Cloud and Encrypted Index Generated');</script>  
        <%}
        %>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <center><div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                <h3 class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">File Upload</h3>
                                <br>
                                <form action="Upload" method="post" ENCTYPE="multipart/form-data">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="text" name="key1" class="form-control" id="subject" required="" placeholder="Email">
                                                <label for="subject">Keyword 1</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="text" name="key2" class="form-control" id="subject" required="" placeholder="Email">
                                                <label for="subject">Keyword 2</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="text" name="key3" class="form-control" id="subject" required="" placeholder="Email">
                                                <label for="subject">Keyword 3</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <label>Upload File less than 1mb</label>
                                            <div class="form-floating">
                                                <input type="file" name="upfile" class="form-control" id="subject" required="" placeholder="Password">
