<%-- 
    Document   : EncIndex
    Created on : Dec 18, 2022, 9:13:26 PM
    Author     : Murthi
--%>
                    ...
                    <div class="col-lg-12">
                        ...
                        <center><table id="naresh">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from encindex where oid ='" + oid + "'");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    <td><%=rs.getString("id")%></td>
                                    <td><%=rs.getString("fid")%></td>
                                    <td><%=rs.getString("key1")%></td>
                                    <td><%=rs.getString("key2")%></td>
                                    <td><%=rs.getString("key3")%></td>
                                </tr>
                                <%                                        }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
