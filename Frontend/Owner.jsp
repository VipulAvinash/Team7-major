<%-- 
    Document   : Owner
    Created on : Dec 14, 2022, 9:16:54 PM
    Author     : Murthi
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <script>alert('Your not yet approved. please try again later');</script>  
        <%}
        %>
        <%
                    if (request.getParameter("success") != null) {%>
        <script>alert('Owner Registration Success');</script>  
        <%}
        %>
        <%
                    if (request.getParameter("Authentication_Failed") != null) {%>
        <script>alert('Authentication Failed. Incorrect Username and passord');</script>  
        <%}
        %>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <center><div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                <h3 class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">Owner</h3>
                                <br>
                                <form action="OwnerLog" method="post">
                                    <div class="row g-3">
                                        <div class="col-12">
                                    ...
                                    <br><br>
                                    New Owner?? <a href="ownerreg.jsp">Register</a>
                                </form>
                            </div></center> 
                        <br><br><br><br><br><br><br>
