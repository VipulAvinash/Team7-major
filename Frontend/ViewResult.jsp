<%-- 
    Document   : ViewResult
    Created on : Dec 19, 2022, 10:35:14 PM
    Author     : Murthi
--%>
...
<html lang="en">
    ...
    <script>alert('No results found for the keyword you entered');</script>  
    <%}
    %>
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        while (rs.next()) {
                                            ...
                                            ResultSet rs1 = st.executeQuery("select * from uploads where id ='" + fid + "'");
                                            while (rs1.next()) {
                                %>
                                <tr>
                                    <td><%=rs1.getString("id")%></td>
                                    <td><%=rs1.getString("fname")%></td>
                                    <td><%=rs1.getString("ftype")%></td>
                                    <td><%=rs1.getString("time")%></td>
                                    <td><a href="Download?fid=<%=rs1.getString("id")%>&id=<%=id%>">Download</a></td>
