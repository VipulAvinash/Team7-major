<%-- 
    Document   : UserAct
    Created on : Dec 18, 2022, 10:09:26 PM
    Author     : Murthi
--%>
...
<html lang="en">
 ...
 <%
        ...
        <script>alert('Access Granted and Secret key Genearted');</script>  
        <%}
        %>
 <%
                    ...
                    <div class="col-lg-12">
                        ...
                        <center><table id="naresh">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from users where ustatus ='No'");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td><a href="UserActivate?uid=<%=rs.getString("id")%>"  class="btn btn-success" style="color: white">&nbsp;Approve</a>&nbsp;&nbsp;
