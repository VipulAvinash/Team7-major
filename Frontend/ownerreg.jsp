<%-- 
    Document   : ownerreg
    Created on : Dec 14, 2022, 9:18:52 PM
    Author     : Murthi
--%>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <center><div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                <h3 class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">Owner Registration</h3>
                                <br>
                                <form action="OwnerReg" method="post">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="date" name="dob" class="form-control" id="email" placeholder="DOB">
                                                <label for="name">DOB</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" name="gender" class="form-control" id="email" placeholder="Gender">
                                                <label for="name">Gender</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="email" name="email" class="form-control" id="subject" placeholder="Email">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="password" name="pass" class="form-control" id="subject" placeholder="Password">
                                    ...
                                    <br><br>
                                    Already Registered?? <a href="Owner.jsp">Login</a>
                                </form>
                            </div></center> 
                        <br><br><br><br><br><br><br>
