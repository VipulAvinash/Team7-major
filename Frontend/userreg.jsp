<%-- 
    Document   : User
    Created on : Dec 14, 2022, 6:42:48 PM
    Author     : Murthi
--%>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <center><div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                <h3 class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">User Registration</h3>
                                <br>
                                <form action="UserReg" method="post">
                                    ...
                                    <br><br>
                                    Already Registered?? <a href="User.jsp">Login</a>
                                </form>
                            </div></center> 
                        <br><br><br><br><br><br><br>
