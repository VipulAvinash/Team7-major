<%-- 
    Document   : VA
    Created on : Dec 19, 2022, 1:38:07 AM
    Author     : Murthi
--%>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <center><div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                <p class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">Verification Authority</p>
                                <form method="post" action="VALog">
                                    <div class="row g-3">
                                        <div class="col-12">
