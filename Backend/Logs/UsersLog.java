 ...
 * @author Murthi
 */
public class UsersLog extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ResultSet rs1 = st1.executeQuery("SELECT * FROM users where email='" + email + "' AND pass='" + pass + "'");
                System.out.println("Check 1 Pass");
                if (rs1.next()) {
                    ResultSet rs = st.executeQuery("SELECT * FROM users where email='" + email + "' AND pass='" + pass + "' AND ustatus='Active' ");
                    if (rs.next()) {
                        ...
                        int i = sto.executeUpdate("update users set lastlog='" + time + "' where email = '" + email + "' ");
